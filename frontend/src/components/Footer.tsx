...
const AbhiBusComponent = () => {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.heading}>Why Choose EasyRide for Bus Ticket Booking ?</h2>
      <p style={styles.subHeading}>
        EasyRide is India’s fastest growing online ticket booking platform... over
      ...
      <div style={styles.assuredSection}>
        <div style={styles.assuredBadge}>EasyRide Assured</div>
